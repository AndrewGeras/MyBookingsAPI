...
@app.put("/hotels/{hotel_id}", description="<strong>Полное</strong> редактирование данных об отеле")
def update_hotel(
        hotel_id: int,
        title: str = Body(),
        name: str = Body(),
...
@app.patch("/hotels/{hotel_id}", description="<strong>Частичное</strong> редактирование данных об отеле")
def edit_hotel(
        hotel_id: int,
